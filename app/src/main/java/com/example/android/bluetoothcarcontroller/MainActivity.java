package com.example.android.bluetoothcarcontroller;
...
public class MainActivity extends AppCompatActivity {
    private final String DEVICE_ADDRESS = "F9:E0:D8:5F:3E:53"; //MAC Address of Bluetooth Module
    private final UUID PORT_UUID = UUID.fromString("00001530-1212-EFDE-1523-785FEABCD123");
